...
To begin, we need to scrape the data. The code is provided below, if desired.
...
Next, with the data successfully scraped, we read in the R data objects into our local environment and take a look at the raw data.
